...
public class WorldListener implements Listener{
	...
	public void onBlockBreak(BlockBreakEvent event){
		...
		if((player.getWorld().getEnvironment() == World.Environment.NETHER) && ((event.getBlock().getState() instanceof CreatureSpawner)) && (!player.hasPermission("idaniel84.faction.protection.bypass"))){
