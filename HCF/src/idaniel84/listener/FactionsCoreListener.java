...
public class FactionsCoreListener
		implements Listener{
	public static final String PROTECTION_BYPASS_PERMISSION = "idaniel84.faction.protection.bypass";
	...
	public static boolean attemptBuild(Entity entity, Location location, String denyMessage, boolean isInteraction){
		...
		if(entity instanceof Player){
			...
			if(player != null && player.getGameMode() == GameMode.CREATIVE && player.hasPermission("idaniel84.faction.protection.bypass")){
				return true;
			}
