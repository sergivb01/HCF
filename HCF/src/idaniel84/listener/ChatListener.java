...
import idaniel84.faction.event.FactionChatEvent;
...
public class ChatListener
	...
	public void onPlayerChat(AsyncPlayerChatEvent event){
		...
		if(lastMessage != null && (message.equals(lastMessage) || StringUtils.getLevenshteinDistance(cleanedMessage, lastMessage) <= 1) && !player.hasPermission("idaniel84.doublepost.bypass")){
