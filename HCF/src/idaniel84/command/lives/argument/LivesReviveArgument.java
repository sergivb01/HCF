...
public class LivesReviveArgument
	...
	private static final String REVIVE_BYPASS_PERMISSION = "idaniel84.revive.bypass";
	private static final String REVIVE_DTR = "idaniel84.revive.dtr";
	...
	public LivesReviveArgument(HCF plugin){
		...
		this.plugin = plugin;
		this.permission = "idaniel84.command.lives.argument." + this.getName();
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
		...
		if(sender instanceof Player){
			if(!sender.hasPermission("idaniel84.revive.bypass") && this.plugin.getEotwHandler().isEndOfTheWorld()){
				sender.sendMessage(ChatColor.RED + "You cannot revive players during EOTW.");
				return true;
			}
			if(!sender.hasPermission("idaniel84.revive.bypass")){
			...
			}else if(sender.hasPermission("idaniel84.revive.dtr")){
