...
public class DeathbanListener
	...
	private static final String DEATH_BAN_BYPASS_PERMISSION = "idaniel84.deathban.bypass";
	...
	public void onPlayerLogin(PlayerLoginEvent event){
		...
		if(player.hasPermission("idaniel84.deathban.bypass")){
	...
	public void onPlayerDeath(PlayerDeathEvent event){
		...
		if(player.hasPermission("idaniel84.deathban.bypass")) return;
